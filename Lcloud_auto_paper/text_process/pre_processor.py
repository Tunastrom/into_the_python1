...
def pre_processor(split_set, delete_set, needcolumns_dict, needdatas_set):  
    print('전 처리 시작')
    # 전체 내용에서 단어 사이의 띄어쓰기 제거 및 값 없는 컬럼의 이름 삭제 
    contents_str = ''
    with open('C:/Users/Administrator/Desktop/test_log/LCN_NBUActivity_202102.txt', 'r') as f:
        contents_str = f.read()
    ...
    with open('C:/Users/Administrator/Desktop/test_log/LCN_NBUActivity_202102_rewrite.txt', 'w') as f:
        f.write(contents_str)
        print('rewrite 완료')

    with open('C:/Users/Administrator/Desktop/test_log/LCN_NBUActivity_202102_rewrite.txt', 'r') as f:
